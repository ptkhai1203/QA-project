...
def get_setup_args():
    ...
    parser.add_argument('--train_url',
                        type=str,
                        default='/data/logiqa_train.json')
    parser.add_argument('--dev_url',
                        type=str,
                        default='/data/logiqa_eval.json')
    parser.add_argument('--test_url',
                        type=str,
                        default='/data/logiqa_test.json')
    parser.add_argument('--glove_url',
                        type=str,# default= 'https://nlp.stanford.edu/data/glove.6B.zip')
    ...
    parser.add_argument('--op_limit',
                        type=int,
                        default=200,
                        help='Max number of words to keep from a option')
    ...
    parser.add_argument('--test_op_limit',
                        type=int,
                        default=200,
                        help='Max number of words in a option at test time')
...
def get_train_args():
    ...
    elif args.metric_name in ('EM', 'F1', 'ACC'):
